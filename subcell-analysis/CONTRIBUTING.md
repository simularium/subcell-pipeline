...
Ready to contribute? Here's how to set up `subcell-analysis` for local development.

1. Fork the `subcell-analysis` repo on GitHub.

2. Clone your fork locally:

    ```bash
    git clone git@github.com:{your_name_here}/subcell-analysis.git
    ```
