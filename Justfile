...
# run tests
test:
	pytest --cov-report xml --cov-report html --cov=subcell_analysis subcell_analysis/tests
...
generate-docs:
	rm -f docs/subcell_analysis*.rst
	rm -f docs/modules.rst
	sphinx-apidoc -o docs subcell_analysis **/tests
